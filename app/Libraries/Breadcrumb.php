...
class Breadcrumb
{
    ...
    public function __construct()
    {
        ...
        $this->tags['navopen']  = "";
        $this->tags['navclose'] = "";
        $this->tags['olopen']   = "<ol class=\"breadcrumb fs-sm mb-1\">";
        $this->tags['olclose']  = "</ol>";
        $this->tags['liopen']   = "<li class=\"breadcrumb-item\">";
        $this->tags['liopen-active']   = "<li class=\"breadcrumb-item active\">";
    ...
    public function add($crumb, $href = '')
    {
        ...
        if (!$crumb) return; // if the title or Href not set return 
    ...
    public function render()
    {
        ...
        foreach ($this->breadcrumbs as $index => $breadcrumb) {
            ...
            if ($index == $count) {
                $output .= $this->tags['liopen-active'];
